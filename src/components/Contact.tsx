        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-8">
          <div>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <a href="mailto:contact@charantejayadav.com" className="text-muted-foreground hover:text-highlight transition-colors">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  required
                  className="bg-card/50 border-border/50 focus-visible:ring-highlight"
                />
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                ...
                required
                rows={5}
                className="bg-card/50 border-border/50 focus-visible:ring-highlight resize-none"
              />
            </div>
            
            <Button type="submit" className="bg-highlight text-navy-950 hover:bg-highlight/90 w-full sm:w-auto">
